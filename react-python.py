...
run_command("py -m venv env", cwd=base_path)
venv_bin = base_path / "env/Scripts/activate"
activate_cmd = f"{venv_bin}" if os.name == 'nt' else f"source {base_path}/env/bin/activate"
